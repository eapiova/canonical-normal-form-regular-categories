...
We previously gave a partial formalisation in Coq covering the empty context case~\cite{borsetto2023}, and we extend it here to a complete one in Agda~\cite{regcat2026}. As future work, we plan to investigate whether the argument extends along the modular hierarchy up to topoi.
